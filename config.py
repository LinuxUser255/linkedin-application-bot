...
# In Firefox browser put in the URL:
# about:profiles
# Go to the current user and selecto the root directory
# /home/yourcomputeraccoutname/.mozilla/firefox/<accountnumber>.yourusername"
# For Example:
